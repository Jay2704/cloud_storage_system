...
class Level2Tests(unittest.TestCase):
    ...
    def test_level_2_case_04_top_check_sorting(self):
        ...
        expected = ['/dir/dir/dirfile(5)', '/dir/file1.csv(5)', '/dir/file3.txt(5)', '/dirfile2csv(5)']
    ...
    def test_level_2_case_08_top_mixed_2(self):
        ...
        expected = ['/dirfile.mp4(100)', '/file.mp4(100)', '/dir/library/package/exec(1)']
    ...
    def test_level_2_case_09_top_mixed_3(self):
        ...
        expected = ['/lib/bin/py3.9(79)', '/lib/bin/python3.9(79)', '/lib/bin/python3(78)', '/lib/bin/python2(50)', '/lib/bin/exec.sh(34)']
        self.assertEqual(self.storage.get_n_largest('/', 10), expected)
        ...
        expected = ['/lib/bin/py3.9(79)', '/lib/bin/python3.9(79)', '/lib/bin/python3(78)', '/lib/bin/python2(50)']
        ...
        expected = ['/lib/exec/exec.sh(300)', '/lib/bin/py3.9(79)', '/lib/bin/python3.9(79)', '/lib/bin/python3(78)']
        ...
        self.assertIsNone(self.storage.delete_file('/lib/bin/py3'))
        expected = ['/lib/exec/exec.sh(300)', '/lib/bin/py3.9(79)', '/lib/bin/python3.9(79)', '/lib/bin/python3(78)', '/lib/bin/python2(50)']
        self.assertEqual(self.storage.get_n_largest('/', 5), expected)
        expected = ['/lib/exec/exec.sh(300)', '/lib/bin/py3.9(79)', '/lib/bin/python3.9(79)', '/lib/bin/python3(78)', '/lib/bin/python2(50)', '/lib/bin/exec.sh(34)']
    ...
    def test_level_2_case_10_top_mixed_4(self):
        ...
        self.assertTrue(self.storage.add_file('/library/bin/containers/video3435.mp4', 146))
        ...
        expected = ['/collection/audio/img.img(224)', '/collection/pic_pic.png(172)', '/collection/img.img(113)', '/collection/images/filename(106)', '/collection/images/pic_pic.png(85)', '/collection/video3435.mp4(84)']
        self.assertEqual(self.storage.get_n_largest('/collection', 13), expected)
        expected = ['/library/main.cpp(154)', '/library/bin/containers/video3435.mp4(146)', '/library/bin/containers/filename(43)', '/library/bin/packages/pic_pic.png(42)', '/library/bin/video3435.mp4(2)']
        self.assertEqual(self.storage.get_n_largest('/library', 17), expected)
        expected = ['/video3435.mp4(285)', '/index.html(252)', '/collection/audio/img.img(224)', '/trash/exec.exec(177)', '/collection/pic_pic.png(172)', '/library/main.cpp(154)']
        self.assertEqual(self.storage.get_n_largest('/', 6), expected)
        expected = ['/video3435.mp4(285)', '/index.html(252)', '/collection/audio/img.img(224)', '/trash/exec.exec(177)', '/collection/pic_pic.png(172)', '/library/main.cpp(154)', '/library/bin/containers/video3435.mp4(146)', '/collection/img.img(113)', '/collection/images/filename(106)', '/collection/images/pic_pic.png(85)', '/collection/video3435.mp4(84)', '/trash/script.js(79)', '/library/bin/containers/filename(43)', '/library/bin/packages/pic_pic.png(42)', '/trash/img.img(18)']
        self.assertEqual(self.storage.get_n_largest('/', 15), expected)
