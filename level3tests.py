...
class Level3Tests(unittest.TestCase):
    ...
    def test_level_3_case_04_merge_users(self):
        ...
        expected = ['/files/file2.mp4(40)', '/files/file1.txt(30)', '/files/file3.mov(20)']
    ...
    def test_level_3_case_08_users_mixed_2(self):
        ...
        expected = ['/dir/top_file3(38)', '/dir/dir/top_file2(33)', '/dir/last_file(30)', '/dir/new_top(21)']
    ...
    def test_level_3_case_10_users_mixed_4(self):
        ...
        self.assertEqual(self.storage.add_file_by('user1', '/dir1/deep_dir/file5.mkv', 40), 95)
